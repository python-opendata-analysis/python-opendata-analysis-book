...
| 9 | 285ページ | 本節冒頭で説明したように gBizINFO は 2026 年 1 月に次期システムに移行し、2025 年 9 月から現行システムの API 利用申請の受付が中止されます。本書のサポートサイト（1.3.3 項に記載）にて、2026 年 1 月以降に、次期システムの仕様に対応した修正コードを提供予定です。以下では、API 利用申請の受付が停止している旧システムの仕様にもとづいて gBizINFO の API を紹介します。 | 本節冒頭で説明したように gBizINFOは2026年1月にREST APIのv1からv2にシステム移行しました。本書のサポートサイト（1.3.3 項に記載）にて、現在、v2の仕様に対応した修正コードを提供しています。 | 3刷予定 | サービス提供システムの変更のため |
